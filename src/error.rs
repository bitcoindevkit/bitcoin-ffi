...
impl From<BitcoinPsbtError> for PsbtError {
    fn from(error: BitcoinPsbtError) -> Self {
        match error {
            ...
            BitcoinPsbtError::UnsignedTxHasScriptWitnesses => PsbtError::UnsignedTxHasScriptWitnesses,
            ...
            BitcoinPsbtError::InvalidSecp256k1PublicKey(e) => PsbtError::InvalidSecp256k1PublicKey {
